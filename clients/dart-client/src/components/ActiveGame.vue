...
export default class ActiveGame extends Vue {
  ...
  onScoreClick(payload: { multiplier: '1' | '2' | '3', field: number }) {
    console.log('Registered ' + payload.multiplier + ' * ' + payload.field);
    store.dispatch('insertThrow', { field: payload.field, multiplier: payload.multiplier }); 
  }
